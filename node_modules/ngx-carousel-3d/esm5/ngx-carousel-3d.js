...
import * as jqueryProxy__default from 'jquery';
import jqueryProxy__default__default, {  } from 'jquery';
...
var jquery = jqueryProxy__default__default || jqueryProxy__default;
var NgxCarousel3dComponent = /** @class */ (function () {
    ...
    NgxCarousel3dComponent.prototype.subscribe = function () {
        var _this = this;
        this.$timer = Observable.timer(this.carousel3d.autoRotationSpeed, this.carousel3d.autoRotationSpeed).subscribe(function () {
