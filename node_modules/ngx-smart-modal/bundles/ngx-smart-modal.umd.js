...
}(this, (function (exports,_angular_core,_angular_animations,_angular_common) { 'use strict';
...
var NgxSmartModalComponent = (function () {
    ...
    function NgxSmartModalComponent(ngxSmartModalService, changeDetectorRef) {
        ...
        this.onDataAdded = new _angular_core.EventEmitter();
        this.onDataRemoved = new _angular_core.EventEmitter();
...
NgxSmartModalComponent.propDecorators = {
    ...
    'escapeAble': [{ type: _angular_core.Input },],
    ...
    'force': [{ type: _angular_core.Input },],
    'visibleChange': [{ type: _angular_core.Output },],
    'onClose': [{ type: _angular_core.Output },],
    'onDismiss': [{ type: _angular_core.Output },],
    'onOpen': [{ type: _angular_core.Output },],
    'onEscape': [{ type: _angular_core.Output },],
    'onDataAdded': [{ type: _angular_core.Output },],
    'onDataRemoved': [{ type: _angular_core.Output },],
    'escapeKeyboardEvent': [{ type: _angular_core.HostListener, args: ['document:keydown', ['$event'],] },],
};
